...
public class CustomAdapterReceipt extends RecyclerView.Adapter<CustomAdapterReceipt.MyViewHolder> {

    private Context context;
    Activity activity;
    private List<ItemModel> itemModels;

    public CustomAdapterReceipt(Context context, Activity activity, List<ItemModel> itemModels) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.my_row_receipt, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomAdapterReceipt.MyViewHolder holder, final int position) {
